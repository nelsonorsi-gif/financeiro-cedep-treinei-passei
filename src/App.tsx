...
function App() {
  ...
  const salvarLancamentoManual =
    (
      ...
      const identificacaoCaixa = registrarMovimentoCaixa(usuarioAtual, {
        ...
        descricao,
        tipoEntrada: tipo === "Entrada" ? formulario.tipoEntrada : "",
        tipoSaida: tipo === "Saída" ? formulario.tipoSaida : "",
        valor,
  ...
  const estornarLancamento = (lancamento: Lancamento) => {
    ...
    const movimentoEstorno = registrarMovimentoCaixa(usuarioAtual, {
      ...
      tipoEntrada: lancamento.saida > 0 ? (lancamento.tipoSaida || "Despesa") : "",
      tipoSaida: lancamento.entrada > 0 ? (lancamento.tipoEntrada || "Receita") : "",
