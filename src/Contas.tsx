  ...
  const confirmarBaixa = async () => {
    ...
    try {
      ...
      registrarMovimentoCaixa(usuarioAtual, {
        ...
        tipoEntrada: tipo === "receber" ? (atualizada.categoria || "Conta recebida") : "",
        tipoSaida: tipo === "pagar" ? (atualizada.categoria || "Conta paga") : "",
        valor: valorRecebido,
        formaPagamento,
  ...
  const estornarPagamentos = async (conta: Conta) => {
    ...
    try {
      ...
      registrarMovimentoCaixa(usuarioAtual, {
        ...
        tipoEntrada: tipo === "pagar" ? (conta.categoria || "Conta paga") : "",
        tipoSaida: tipo === "receber" ? (conta.categoria || "Conta recebida") : "",
        valor: valorEstorno,
